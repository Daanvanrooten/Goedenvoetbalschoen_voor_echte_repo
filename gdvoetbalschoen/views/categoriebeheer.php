...
<body>
    ...
    <script>
        function fetchCategories() {
            fetch('../api/categories/categorie_api.php?action=list')
                .then(res => res.json())
                .then(data => {
        ...
        document.getElementById('addCatForm').addEventListener('submit', function(e) {
            ...
            fetch('../api/categories/categorie_api.php?action=add', {
                    method: 'POST',
                    headers: {
        ...
        window.editCat = function(id, oldName) {
            ...
            if (newName && newName !== oldName) {
                fetch('../api/categories/categorie_api.php?action=edit', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                        },
        ...
        window.deleteCat = function(id) {
            if (confirm('Weet je zeker dat je deze categorie wilt verwijderen?')) {
                fetch('../api/categories/categorie_api.php?action=delete', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                        },
